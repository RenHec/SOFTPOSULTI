                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('mobile', $contact->mobile, ['class' => 'form-control', 'placeholder' =>
                            __('contact.mobile')]); !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-4">
                    <div class="form-group individual">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('dob', !empty($contact->dob) ? @format_date($contact->dob) : null, ['class'
                            => 'form-control dob-date-picker','placeholder' => __('lang_v1.dob'), 'readonly']); !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 lead_additional_div">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::select('crm_source', $sources, $contact->crm_source , ['class' => 'form-control',
                            'id' => 'crm_source','placeholder' => __('messages.please_select')]); !!}
                        </div>
                    </div>
                </div>
                <div class="col-md-4 lead_additional_div">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::select('crm_life_stage', $life_stages, $contact->crm_life_stage , ['class' =>
                            'form-control', 'id' => 'crm_life_stage','placeholder' => __('messages.please_select')]);
                            !!}
                        </div>
                    </div>
                </div>
                <div class="col-md-6 lead_additional_div">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::select('user_id[]', $users, $lead_users , ['class' => 'form-control select2', 'id'
