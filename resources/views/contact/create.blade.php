            ...
            <div class="row">
                <div class="col-md-4 contact_type_div">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::select('type', $types, $type , ['class' => 'form-control', 'id' =>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('contact_id', null, ['class' => 'form-control','placeholder' =>
                ...
                <div class="col-md-3 individual" style="display: none;">
                    <div class="form-group">
                        ...
                        {!! Form::text('middle_name', null, ['class' => 'form-control', 'placeholder' => __(
                        'lang_v1.middle_name' ) ]); !!}
                    </div>
                </div>
                <div class="col-md-3 individual" style="display: none;">
                ...
                <div class="col-sm-4 individual" style="display: none;">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('dob', null, ['class' => 'form-control dob-date-picker','placeholder' =>
                            __('lang_v1.dob'), 'readonly']); !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 lead_additional_div">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::select('crm_source', $sources, null , ['class' => 'form-control', 'id' =>
                            'crm_source','placeholder' => __('messages.please_select')]); !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 lead_additional_div">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::select('crm_life_stage', $life_stages, null , ['class' => 'form-control', 'id' =>
                            'crm_life_stage','placeholder' => __('messages.please_select')]); !!}
                        </div>
                    </div>
                </div>
                <div class="col-md-6 lead_additional_div">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::select('user_id[]', $users, null , ['class' => 'form-control select2', 'id' =>
                            'user_id', 'multiple', 'required', 'style' => 'width: 100%;']); !!}
                        </div>
                    </div>
                </div>
                <div class="clearfix"></div>
                ...
                <div id="more_div" class="hide">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::text('tax_number', null, ['class' => 'form-control', 'placeholder' =>
                                __('contact.tax_no')]); !!}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 pay_term">
                        <div class="form-group">
                            <div class="multi-input">
                                ...
                                __('lang_v1.days')], '', ['class' => 'form-control width-60 pull-left','placeholder' =>
                    ...
                    <div class="col-md-4 customer_fields">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::text('credit_limit', $default_credit_limit ?? null, ['class' => 'form-control
                                input_number']); !!}
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('address_line_1', null, ['class' => 'form-control', 'placeholder' =>
                            __('lang_v1.address_line_1'), 'rows' => 3]); !!}
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('shipping_custom_field_details[shipping_custom_field_1]', null, ['class' =>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('shipping_custom_field_details[shipping_custom_field_2]', null, ['class' =>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('shipping_custom_field_details[shipping_custom_field_3]', null, ['class' =>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('shipping_custom_field_details[shipping_custom_field_4]', null, ['class' =>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('shipping_custom_field_details[shipping_custom_field_5]', null, ['class' =>
                    ...
                    @for($i; $i <= 6 ; $i++) <div class="col-md-4 export_div" style="display: none;">
                        <div class="form-group">
                            ...
                            {!! Form::text('export_custom_field_'.$i, null, ['class' => 'form-control','placeholder' =>
