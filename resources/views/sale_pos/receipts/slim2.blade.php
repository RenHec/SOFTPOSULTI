	...
	<div class="ticket">
		<div class="text-box">
			<p class="centered">
				...
				<span class="headings" style="font-size: 18px;">{!! $receipt_details->header_text !!}</span>
				<br />
				@endif
		...
		<div class="border-top textbox-info">
			...
			<p class="f-right" style="font-size: 18px;">
		...
		<div class="textbox-info">
			...
			<p class="f-right" style="font-size: 18px;">{{$receipt_details->due_date ?? ''}}</p>
		</div>
		@endif
		...
		<div class="textbox-info">
			...
			<p class="f-right" style="font-size: 18px;">{{$receipt_details->sales_person}}</p>
		</div>
		@endif
		...
		<div class="textbox-info">
			...
			<p class="f-right" style="font-size: 18px;">{{$receipt_details->repair_brand}}</p>
		</div>
		@endif
		...
		<div class="textbox-info">
			...
			<p class="f-right" style="font-size: 18px;">{{$receipt_details->repair_device}}</p>
		</div>
		@endif
		...
		<div class="textbox-info">
			...
			<p class="f-right" style="font-size: 18px;">{{$receipt_details->repair_model_no}}</p>
		</div>
		@endif
		...
		<div class="textbox-info">
			...
			<p class="f-right" style="font-size: 18px;">{{$receipt_details->repair_serial_no}}</p>
		</div>
		@endif
		...
		<div class="textbox-info">
			<p style="vertical-align: top;"><strong>
				...
				<span style="vertical-align: top; font-size: 18px;">{!! $receipt_details->customer_info !!}</span>
			</p>
		</div>
