			...
			<td>
				...
				<div class="row invoice-info">
					...
					<div class="col-xs-12 text-center">
						...
						<p>
							<strong>{{ $receipt_details->customer_label }}</strong> {{$receipt_details->customer_name ??
							''}} <br>
						...
						<table class="table table-bordered table-no-top-cell-border">
							<thead>
								<tr style="background-color: #357ca5 !important; color: white !important; font-size: 20px !important"
									...
									<td
										style="background-color: #357ca5 !important; color: white !important; width: 20% !important;">
