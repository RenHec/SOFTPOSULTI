    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                select2_register','placeholder' => __('business.currency_placeholder'), 'required']); !!}
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::select('time_zone', $timezone_list, config('app.timezone'), ['class' => 'form-control
                select2_register','placeholder' => __('business.time_zone'), 'required']); !!}
            </div>
        </div>
    </div>
</fieldset>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::select('fy_start_month', $months, null, ['class' => 'form-control select2_register',
    ...
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                select2_register', 'required', 'style' => 'width:100%;']); !!}
            </div>
        </div>
    </div>
</fieldset>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                __('business.confirm_password'), 'required']); !!}
            </div>
        </div>
    </div>
    <div class="clearfix"></div>
