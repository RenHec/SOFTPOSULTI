...
class CashRegisterController extends Controller
{
    ...
    public function getRegisterDetails()
    {
        ...
        try {
            ...
            dd("Error al consultar información de caja");
        }
    }
    ...
    public function getCloseRegister($id = null)
    {
        ...
        try {
            ...
            dd("Error al crear el formulario para cerrar la caja");
        }
    }
    ...
    public function postCloseRegister(Request $request)
    {
        ...
        try {
            $caja = CashRegister::where('user_id', Auth::user()->id)
                ->where('status', 'open')->first();

            if (is_null($caja)) {
                $output = [
                    'success' => 0,
                    'msg' => "Solo puede cerrar la caja el usuario que la abrio."
                ];
            } else {
