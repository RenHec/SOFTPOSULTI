                    ...
                    if (!empty($value[0])) {
                                ...
                                try {
                                    $unit = Unit::create(
                                        [
                                            ...
                                            'short_name'  => substr($unit_name, 0, 3),
                                            'allow_decimal' => false,
                                            'created_by'  => $user_id,
                                            'base_unit_id' => null,
                                    ...
                                    $is_valid = false;
                                    $error_msg = "Unit with name $unit_name not found in row no. $row_no. You can add unit from Products > Units, error: {$th->getMessage()}";
                                    break;
                                }
                            }
                        } else {
                        ...
                        if (!empty($sku)) {
                            ...
                            if (!is_null($is_exist)) {
                                ...
                                $agregado = DB::table('product_locations')
                                    ->where(
                                        [
