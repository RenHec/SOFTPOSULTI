...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    if (Config::get('facturaDTE.activar', false)) {
        Route::name('dte.')->group(function () {
            Route::get('dte/certificar/{transaccion}', 'DTE\ControlFELController@certificar')->name('certificar');

            Route::get('dte/anular/{certificado}', 'DTE\AnulacionFELController@anular')->name('anular');
        });
    }
